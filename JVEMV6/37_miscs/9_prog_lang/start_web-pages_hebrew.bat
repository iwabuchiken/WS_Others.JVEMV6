...
set url_1="http://www.qbible.com/hebrew-old-testament/proverbs/6.html#1"
set url_2=https://www.scripture4all.org/OnlineInterlinear/OTpdf/pro6.pdf
set url_3=https://www.mechon-mamre.org/p/pt/pt2806.htm
