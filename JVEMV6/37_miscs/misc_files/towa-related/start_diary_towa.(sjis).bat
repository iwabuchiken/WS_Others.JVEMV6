...
REM 	ref : •¶š‰»‚¯ https://www.adminweb.jp/command/display/index5.html
REM =================================
...
REM launcher.exe "http://benfranklin.chips.jp/cake_apps/Cake_IFM11/images/index_2?filter_memo=“Œ˜a+“ú&RBs_AND_OR_Memo=AND&sort=file_name&direction=desc"
